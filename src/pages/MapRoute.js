...
const route = [
  {
    id: 235524, orders: [
      ...
      { id: 952880 },
      { id: 240057 },
    ], from: 'Москва, Профсоюзная', to: "Санкт-Петербург", currenGeo: [58.571620, 32.257039]
  },
  {
    id: 46486456, orders: [
      { id: 266761 },
  ...
  return (
    <>
      ...
      <>
        ...
        <input type="text" value={inputOrder} onChange={(e) => setInputOrder(e.target.value)} />
        <button onClick={() => inputOrder ? findOrder(inputOrder) : null}>Отследить заказ</button>
        {data.from} {data.to} {data.currenGeo}
        ...
        >
          ...
          >
            ...
            <Placemark geometry={data.currenGeo} />
